...
상태: **구상안과 개념 검증 렌더 1장만 있다. 영상은 아직 없다. Astra 교차검증 대기(`ASTRA_REVIEW_REQUEST.md`), 회신 전까지 확정안이 아니다.** 홈페이지는 계속 v3(잠깐만요!)를 재생한다.
...
| 파일 | 내용 |
|---|---|
| `ASTRA_REVIEW_REQUEST.md` | Astra에게 보내는 교차검증 질문 11개와 회신 형식. 회신은 `ASTRA_REVIEW.md`로 같은 폴더에 저장 |
