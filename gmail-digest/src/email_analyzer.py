...
**중요도 판단 기준:**
- 🔴 HIGH (8-10): 직접 답장/행동이 필요한 메일
  - 연구/학술: 동료/학생 요청, 논문 리뷰 요청, 학회 초대, 인용 알림, 프로젝트 관련
  - 공공/행정: 과태료 고지, 벌금, 세금, 관공서(korea.kr, go.kr) 통지, 법원/경찰 관련, 교통 위반
  - 금융/결제: 은행 알림, 카드 결제, 보험, 이상거래 감지
  - 보안: 비밀번호 변경, 계정 침해, 로그인 경고
  - 개인 연락: 특정인이 직접 보낸 요청/질문 (자동발송 아닌 것)
- 🟡 MEDIUM (5-7): 참고할 가치 있음 (기술 뉴스레터, 연구 관련 업데이트, 서비스 변경 공지, 택배/배송 알림)
- ⚪ LOW (1-4): 무시 가능 (일반 공지, 루틴 알림, 광고, 프로모션)
