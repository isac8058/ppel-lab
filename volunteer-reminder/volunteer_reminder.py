#!/usr/bin/env python3
"""
광주채플 식당 홀 청소 알림 (격주 A/B조 운영, 2026-09 재편성)
...
# =========================================================
# 편성표 (2026-09 재편성)
# 마을 번호: 211 정상연, 212 배철한, 213 조윤희F,
#            214 송두헌, 215 김영석A
# 2026-09 변경: 모종명 제외(부목자 사임), 이경모·문형식 신규 A조 편성,
#               홍성일A A->B / 김중백 B->A / 박광진 A->B 재배치
# =========================================================
TEAMS = {
    "A": {
        "label": "A조",
        "명단": [
            ...
            "장쾌남",    # 214
            "김대연A",   # 214
            "김중백",    # 214, 2026-09 B조에서 이동
            "김성철E",   # 215
            "이경모",    # 마을 미확인, 2026-09 신규
            "문형식",    # 마을 미확인, 2026-09 신규
        ],
    },
    "B": {
        "label": "B조",
        "명단": [
            ...
            # 부조장 공석 — 2026-08 김대연A A조 이동 이후 미정
            "김도윤B",   # 211
            "박철수B",   # 212
            "오선록",    # 213
            "박광진",    # 213, 2026-09 A조에서 이동
            "김경은E",   # 214
            "정준기C",   # 214
            "홍성일A",   # 214, 2026-09 A조에서 이동
            "정재성A",   # 215
            "안정호D",   # 215
        ],
    },
